...
<div class="card card-bordered h-100">
    <div class="card-inner">
        ...
        <form action="{{ route('videos.update',$SingleData->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="form-group col-md-4 p-0">
                <label class="form-label" for="full-name">Serial</label>
                <div class="form-control-wrap">
                    <input type="number" class="form-control" name="serial" value="{{ $SingleData->serial }}" required>
                </div>
            </div>
            <div class="form-group">
                <label class="form-label" for="full-name">Title</label>
                <div class="form-control-wrap">
                    <input type="text" class="form-control" value="{{ $SingleData->title }}" name="title" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input type="text" class="form-control" name="link" value="{{ $SingleData->link }}" required>
                </div>
            </div>
