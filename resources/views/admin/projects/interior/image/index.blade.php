...
<div class="card card-bordered">
    ...
    <div class="card-inner ">
        ...
        <a href="{{route('projectinterior.index')}}" class="btn btn-primary float-right"><em class="icon ni ni-file-docs"></em><span class="ml-1">Manage Project Interior</span></a>
                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1 float-left">
                                                    <li>
                                                        <form action="{{ route('project-image.destroy', $details->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
