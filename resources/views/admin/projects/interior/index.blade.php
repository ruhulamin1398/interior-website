    ...
    <div class="nk-block-head">
        ...
        <div class="card card-bordered">
            ...
            <div class="card-inner ">
                <h5 class="card-title float-left mt-1 ">Project Interior List</h5>

                <a href="{{route('projectinterior.create')}}" class="btn btn-primary float-right"><em class="icon ni ni-file-docs"></em><span class="ml-1">Add Project Interior</span></a>
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <td class="nk-tb-col nk-tb-col-tools">
                            <ul class="nk-tb-actions gx-1 float-left">
                                <li>
                                    <a href="{{route('projectinterior.edit',$details->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">

                                        <em class="icon ni ni-edit-alt-fill "></em>
                                    </a>
                                </li>
                                <li>
                                    <form action="{{ route('projectinterior.destroy', $details->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
